...
export default function SkillsPage() {
  return <main className="skills-page">
    ...
    <header className="skills-page-hero shell"><p className="eyebrow">TECHNICAL SKILLS &amp; TOOLS</p><h1>Technical depth,<br/><em>connected to evidence.</em></h1><p>An integrated view of analytical methods, business intelligence, machine learning, and the platforms behind practical project outcomes.</p></header>
